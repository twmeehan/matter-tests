...
enum PlasticModel { NoPlasticity, VonMises, DruckerPrager, DPSoft, MCC, MCCHard, MCCHardExp, PerzynaVM, PerzynaDP, PerzynaMuIDP, PerzynaMCC, PerzynaMuIMCC, PerzynaMCCHard, SinterMCC};
