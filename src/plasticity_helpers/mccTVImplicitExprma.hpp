#ifndef MCCTVIMPLICITRMA_HPP
#define MCCTVIMPLICITRMA_HPP

#include "../tools.hpp"
#include "limitedSearchExponential.hpp"


bool MCCTVImplicitExpRMA(T& p, T& q, int& exit, T M, T p00, T beta, T mu, T K, T xi, T epv, T rma_prefac)
/**
